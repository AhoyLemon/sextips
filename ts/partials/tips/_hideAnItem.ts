...
import { preambles } from "../_options.js";

export const hideAnItem: TipCategory = [
  preambles,
  ` Hide `,
  [
    `an eggplant`,
  ...
  [
    ...
    `tell him you wanted to give him something to remember you by, as you suspect he has early onset dimentia.`,
    `deny EVERYTHING.`,
    `call the police.`,
