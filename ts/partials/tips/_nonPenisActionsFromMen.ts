import type { TipCategory } from "../../lib/tipGenerator.js";
import { fakeNames, bodyParts } from "../_options.js";

export const nonPenisActionsFromMen: TipCategory = [
  fakeNames.first.men,
  ` `,
  fakeNames.last,
  ` `,
  [`says`, `tells us`, `confesses`, `writes`],
  ` “`,
  [
    `I love it when`,
    `It turns me on when`,
  ...
  ` `,
  [`a chick`, `a woman`, `a babe`, `a lady`, `a girl`, `my waifu`, `my bae`],
  ` `,
  [
    `tugs on`,
    `slaps`,
